...
<div class="d1"  style="margin-left:523px">
    ...
    <form action="/doregist" method="post" id="form1" @submit="checkForm" >
        ...
        <div class="form-group form-inputsize" :class="[checkpassflag ? 'has-success' : 'has-error']">
...
<script type="text/javascript">
    var app = new Vue({
        ...
        computed : {
            ...
            btnflag: function () {
                return this.telflag&&this.ageflag&&this.passflag&&this.checkpassflag&&this.emailflag
            }
        } ,
        methods : {
            checkForm : function (e){
                if (this.telflag&&this.ageflag&&this.passflag&&this.checkpassflag&&this.emailflag)
                    return true
                e.preventDefault()
            }
        }
