...
<html class="no-js h-100" lang="en">
  ...
  <body class="h-100">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
          ...
          <div class="nav-wrapper">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="/historyEntrust">
        ...
        <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
          ...
          <!-- / .main-navbar -->
          <div class="main-content-container container-fluid px-4" id="history-entrust">
            <!-- Page Header -->
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                <span class="text-uppercase page-subtitle">Overview</span>
                <h3 class="page-title">所有委托查询</h3>
              </div>
            </div>
            <!-- End Page Header -->
            <!-- Default Light Table -->
              ...
              <div class="col">
                <div class="card card-small mb-4">
                  <div class="card-header border-bottom">
                    <h6 class="m-0">总共有&nbsp;<span style="color:#ff130e">{{count_history}}</span>&nbsp;条委托记录，包括当前正在撮合的委托</h6>
                  </div>
                  <div class="card-body p-0 pb-3 text-center">
                    <table class="table mb-0">
                      ...
                      <tr>
                        ...
                        <th scope="col" class="border-0">证券代码</th>
                        <th scope="col" class="border-0">证券名称</th>
                        <th scope="col" class="border-0">委托方向</th>
                        <th scope="col" class="border-0">委托数量</th>
                        <th scope="col" class="border-0">委托价格</th>
                        <th scope="col" class="border-0">委托状态</th>
                      </tr>
                      </thead>
                      <tbody>
                        <tr v-for="(item,index) in historyInfo">
                          <td>{{index+1}}</td>
                          ...
                          <td><span style="color: #ff1660">{{item.status}}</span></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
    ...
    <script src="../../../assets/js/admin/onload/history-entrust.js"></script>
  </body>
</html>